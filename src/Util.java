...
public class Util {
        ...
        for (final File fileEntry : folder.listFiles()) {
            if (fileEntry.isDirectory()) {
                ...
                if(fileEntry.length() < 1000 ){
                    System.out.println(count+" - "+fileEntry.getName() + " ------------ " + fileEntry.length()+"B");
                }
                else{
                    System.out.println(count+" - "+fileEntry.getName() + " ------------ " + fileEntry.length()/1000+"KB");
                }
            }
            count = count+1;
        }    
    ...
    // public static void listaArquivos(final File folder, Map<Integer, File> files){
